...
def main(page: ft.Page):
    ...
    def iniciar_sesion(e):
        ...
        def proceso_login():
            ...
            if usuario == "renzo_@gmail" and password == "admin123":
                mostrar_mensaje("¡Login exitoso! Redirigiendo...", "success")
                time.sleep(1)
                redirigir_dashboard(page)
            else:
    ...
    def redirigir_dashboard(page):
        import Dashboard   # importa Dashboard.py (misma carpeta)
        page.clean()       # limpia la pantalla
        Dashboard.main(page)  # carga la interfaz del dashboard en la misma ventana
