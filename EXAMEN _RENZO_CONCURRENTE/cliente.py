...
def main(page: ft.Page):
    ...
    page.window.center()
    page.title = "Sistema para el cliente"
    ...
    page.add(
        ft.Column(
            [
                ft.Text("🌈 DELIVERY EN MODO CLIENTE -CIUDAD DE HUARAZ",
                ...
                ft.Row(
                    [
                          ft.ElevatedButton("Ver Reportes de pedidos"),
                        ft.ElevatedButton("Reservar pedidos", on_click=reservar_cupo),
