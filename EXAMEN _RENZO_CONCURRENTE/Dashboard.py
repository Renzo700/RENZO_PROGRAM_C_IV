...
def main(page: ft.Page):
    ...
    page.add(
        ft.Column(
            [
                ft.Text("🗿 modo visita de usuario",
                        size=29, weight=ft.FontWeight.BOLD, color="#14EE10"),
                ft.Divider(height=20),
                ft.Text("Bienvenido al sistema de gestión de ventas en modo admin", size=18),
                ft.Divider(height=30),
                ft.Row(
                    [
                        ft.ElevatedButton("Ver Reportes de su pedido"),
                        ft.ElevatedButton("pedir pollo a la brasa", on_click=reservar_cupo),
                        ft.ElevatedButton("agregar chaufa", on_click=reservar_cupo),
