...
class PersonasView(ft.Container):
    def __init__(self, page, cambiar_vista):
        ...
        self.page = page
        # cambiar_vista es una función que recibe una vista (control) y la muestra
        ...
        # --- Botones superiores ---
        self.btn_volver = ft.ElevatedButton("⬅️ Volver", on_click=lambda e: self.cambiar_vista(self.__volver_al_dashboard()))
    ...
    def mostrar_formulario_editar(self, persona_id):
        ...
        from acciones.editar_persona_view import EditarPersonaView
        # Creamos la vista de edición y la mostramos usando cambiar_vista
